...
import { Calendar, TrendingUp, Plus, Edit2, Trash2, ChevronDown, List, FileText } from 'lucide-react';
import { LineChart, Line, ResponsiveContainer, Tooltip, XAxis } from 'recharts';
import { collection, query, orderBy, getDocs, deleteDoc, doc, getDoc } from 'firebase/firestore';
import { db } from '../../firebase';
import AdminMetricsForm from '../admin/AdminMetricsForm';
import { useTranslation } from 'react-i18next';

const MetricsDashboard = ({ client }) => {
